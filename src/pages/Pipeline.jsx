      ...
      <section className="bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 py-20 md:py-28 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-blur-fade-in">
            <p className="text-accent-600 font-medium text-sm tracking-wider uppercase mb-4">Clinical Pipeline</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <ScrollFadeIn>
            <div className="p-8 rounded-2xl border border-navy-100/60 h-full">
              ...
              <h3 className="font-serif text-2xl text-navy-900 mt-2 mb-3">Siplizumab</h3>
          ...
          <ScrollFadeIn delay={100}>
            <div className="p-8 rounded-2xl border border-navy-100/60 h-full">
              ...
              <h3 className="font-serif text-2xl text-navy-900 mt-2 mb-3">ITB100 (Belatacept)</h3>
              <p className="text-navy-600 text-sm leading-relaxed">
          ...
          <ScrollFadeIn delay={200}>
            <div className="p-8 rounded-2xl border border-navy-100/60 h-full">
              ...
              <h3 className="font-serif text-2xl text-navy-900 mt-2 mb-3">ITB200 (ceduprubart)</h3>
              <p className="text-navy-600 text-sm leading-relaxed">
          ...
          <ScrollFadeIn delay={300}>
            <div className="p-8 rounded-2xl border border-navy-100/60 h-full">
              ...
              <h3 className="font-serif text-2xl text-navy-900 mt-2 mb-3">ITB300 (anti-CD117)</h3>
              <p className="text-navy-600 text-sm leading-relaxed">
