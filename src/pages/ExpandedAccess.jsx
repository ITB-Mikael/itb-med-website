    ...
    <section className="bg-dark-bg">
      <div className="max-w-3xl mx-auto px-6 md:px-10 lg:px-16 py-20 md:py-28">
        <div className="animate-blur-fade-in">
          <p className="text-accent-400 font-medium text-sm tracking-wider uppercase mb-4">Policy</p>
        ...
        <div className="prose-navy">
          <div className="space-y-8 text-navy-300 leading-relaxed text-[15px]">
            <div>
            ...
            <div>
              <h2 className="font-serif text-2xl text-white mb-4">Clinical Trials as Primary Access Route</h2>
              <p>
                ...
                <a href="https://clinicaltrials.gov" target="_blank" rel="noopener noreferrer" className="text-accent-400 hover:text-accent-300 underline">clinicaltrials.gov</a>.
              </p>
            </div>

            <div>
              <h2 className="font-serif text-2xl text-white mb-4">Expanded Access Programs</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl text-white mb-4">Eligibility Criteria</h2>
            ...
            <div>
              <h2 className="font-serif text-2xl text-white mb-4">Request Process</h2>
              <p>
                Physicians must submit requests to{' '}
                <span className="font-medium text-white">expanded.access@itb-med.com</span>.
