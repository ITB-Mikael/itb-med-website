    ...
    <section className="bg-dark-bg">
      <div className="max-w-3xl mx-auto px-6 md:px-10 lg:px-16 py-20 md:py-28">
        <div className="animate-blur-fade-in">
          <p className="text-accent-400 font-medium text-sm tracking-wider uppercase mb-4">Legal</p>
          <h1 className="font-serif text-4xl md:text-5xl tracking-tight leading-[1.05] text-white mb-8">
            Privacy & Terms
          </h1>
        </div>

        <div className="space-y-16 text-navy-300 leading-relaxed text-[15px]">
          {/* Privacy Policy */}
          <div>
            <h2 className="font-serif text-3xl text-white mb-6">Privacy Policy</h2>
            <p className="mb-4">Last updated: January 2026</p>

            <div className="space-y-6">
              <div>
                <h3 className="font-serif text-xl text-white mb-3">Information We Collect</h3>
                <p>
              ...
              <div>
                <h3 className="font-serif text-xl text-white mb-3">Cookies</h3>
                <p>
              ...
              <div>
                <h3 className="font-serif text-xl text-white mb-3">How We Use Your Information</h3>
              ...
              <div>
                <h3 className="font-serif text-xl text-white mb-3">Your Rights (GDPR)</h3>
              ...
              <div>
                <h3 className="font-serif text-xl text-white mb-3">Your Rights (CCPA)</h3>
              ...
              <div>
                <h3 className="font-serif text-xl text-white mb-3">Data Controller</h3>
                <p>
                  ...
                  <a href="/contact" className="text-accent-400 hover:text-accent-300 underline">contact form</a>.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Terms of Use */}
          <div>
            <h2 className="font-serif text-3xl text-white mb-6">Terms of Use</h2>

            <div className="space-y-6">
              <div>
                <h3 className="font-serif text-xl text-white mb-3">Informational Purpose</h3>
                <p>
              ...
              <div>
                <h3 className="font-serif text-xl text-white mb-3">No Medical Advice</h3>
                <p>
              ...
              <div>
                <h3 className="font-serif text-xl text-white mb-3">Intellectual Property</h3>
                <p>
              ...
              <div>
                <h3 className="font-serif text-xl text-white mb-3">Forward-Looking Statements</h3>
                <p>
              ...
              <div>
                <h3 className="font-serif text-xl text-white mb-3">External Links</h3>
                <p>
