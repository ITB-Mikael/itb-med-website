...
export default function NotFound() {
  ...
  return (
    <section className="bg-dark-bg min-h-[70vh] flex items-center justify-center">
      <div className="max-w-xl mx-auto px-6 text-center animate-blur-fade-in">
        <p className="text-accent-400 font-sans text-sm font-bold tracking-widest uppercase mb-4">404</p>
        <h1 className="font-serif text-4xl md:text-5xl tracking-tight text-white mb-4">
          Page not found
        </h1>
