  ...
  if (submitted) {
    return (
      <div className="text-center py-16">
        ...
        <h3 className="font-serif text-2xl text-navy-900 mb-3">Thank you for your message</h3>
        <p className="text-navy-600 leading-relaxed">We'll get back to you as soon as possible.</p>
      </div>
    )
  }

  const inputClass = (field) =>
    `w-full px-4 py-3 rounded-lg border transition-colors duration-200 text-navy-900 placeholder:text-navy-300 focus:outline-none focus:ring-2 focus:ring-accent-500/30 focus:border-accent-500 ${
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label htmlFor="firstName" className="block text-sm font-medium text-navy-700 mb-1.5">First Name</label>
        ...
        <div>
          <label htmlFor="lastName" className="block text-sm font-medium text-navy-700 mb-1.5">Last Name</label>
      ...
      <div className="flex items-start gap-3">
        <input
          ...
          className="mt-1 w-4 h-4 rounded border-navy-300 text-accent-500 focus:ring-accent-500"
        />
        <label htmlFor="privacy" className="text-sm text-navy-600 leading-relaxed">
          I agree to the processing of my personal data in accordance with the{' '}
          <a href="/legal" className="text-accent-600 hover:text-accent-700 underline">Privacy Policy</a>.
        </label>
      </div>
