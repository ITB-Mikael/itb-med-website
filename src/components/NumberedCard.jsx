...
export default function NumberedCard({ number, title, description, icon: Icon, delay = 0 }) {
  return (
    <ScrollFadeIn delay={delay}>
      <div className="group relative p-8 rounded-2xl bg-navy-900/50 border border-navy-700/30 hover:border-accent-300/50 transition-all duration-300 hover:shadow-lg h-full">
        ...
        <p className="text-navy-300 leading-relaxed text-[15px]">{description}</p>
      </div>
    </ScrollFadeIn>
  )
}
